...
export default async function OlderTournamentsSection() {
  const { data } = await sanityFetch({
    query: TOURNAMENT_QUERY,
  });
  return (
    <>
      <section className="min-h-[80vh]  bg-gradient-to-b from-black via-black to-black black py-20">
        <div className="flex flex-wrap md:flex-nowrap gap-2 justify-center px-4 md:px-0">
          ...
          >
            ...
            <p className="text-lg leading-8">
              Take a trip down memory lane and revisit our past tournaments and
              events.From fierce competition to lasting friendships, these
              moments captured the heart of the game.
            </p>
          </motion.div>
